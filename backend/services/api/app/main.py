...
Run with:
    uvicorn backend.services.api.app.main:app --reload
"""
...
def _register_routes(application: FastAPI) -> None:
    ...
    from backend.services.api.app.api.routes.health import router as health_router
    from backend.services.api.app.api.routes.metrics import router as metrics_router
