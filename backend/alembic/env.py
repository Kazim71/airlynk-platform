"""
AirLynk — Alembic async migration environment.

Supports both online (connected to DB) and offline (SQL generation) modes
using the async SQLAlchemy engine.

Important: All ORM models MUST be imported here so that Alembic's
auto-generate picks up their metadata.
"""
